...
const UnlimitedLicenseInfo = () => {
    ...
    return (
        <Container>
            ...
            <br /><br />
            <P>This Non-Exclusive <Bold>UNLIMITED</Bold> License Agreement (the “Agreement”), having been made on and effective as of <Bold>{date.toString()}</Bold> (the “Effective Date”) by and between <Bold>Producer Name</Bold> p/k/a <Bold>PanvoirBeats</Bold> (the “Producer” or “Licensor”); and <Bold>Licensee</Bold> residing at <Bold>[N/A]</Bold> (“You” or “Licensee”), sets forth the terms and conditions of the Licensee’s use, and the rights granted in, the Producer’s instrumental music file entitled <Bold>The Beat Title (Contract Preview Only)</Bold> (the “Beat”) in consideration for Licensee’s payment of <Bold>$198.98</Bold> (the “License Fee”), on a so-called <Bold>“UNLIMITED”</Bold> basis.</P>
            <br />
            ...
            <ol style={{ listStyleType: "number" }}>
                <li><Bold>License Fee:</Bold>Producer's receipt of a $198.98 licensee fee (the “Unlimited License Fee”) from you is a precondition to this Unlimited License Agreement.</li>
                <br />
                <li><Bold>Delivery of the Beat:</Bold>Following receipt of the Unlimited License Fee and execution of this Unlimited License Agreement, Producer will email a link to the Beat in 24-bit/44.1k WAV and 320kbps MP3 file format, along with “tracked out” stem files for the Beat (as such terms are understood in the music industry), to the email address you provided to Producer.</li>
                <br />
                <li><Bold>Term:</Bold>The Term of this Unlimited License Agreement shall be in perpetuity (unless terminated earlier pursuant to the terms of this Agreement).</li>
                <br />
            ...
            <ul>
                ...
                <li><Bold>Producer Royalties. </Bold>For Producer's production of the Beat you intend to use in the New Recording, you agree to pay Producer 50% of everything you make from the New Recording (i.e., other than in connection with the Video, which shall be subject to paragraph).</li>
                <li><Bold>Video Royalties. </Bold>You will pay or cause to be paid to Producer 25% of all monies you make in connection with exploitation of the Video (for example without limitation, from ad revenues in connection with monetization on YouTube, from digital or physical sales of the Video, etc.).</li>
            </ul>
...
export default UnlimitedLicenseInfo