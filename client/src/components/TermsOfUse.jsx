...
const TermsOfUse = () => {
    return (
        <Container>
            ...
            <br /><br />
            <Heading>BeatStars Terms & Conditions</Heading>
            <br />
            <I>Effective date: May 25, 2018</I>
            <br /><br />
            <P>BeatStars Inc. ("BeatStars", "us", "we", or "our") operates the BeatStars.com website, BeatStars mobile applications and other related websites and applications (the "Service").
                <br /><br />
            ...
            <ol style={{ listStyleType: "number" }}>
                ...
                <li>The non-exclusive electronic, digital, and mobile rights in the Content to create digital and/or electronic copies and compilations, to distribute, to sell, and to publicly perform the Content via all electronic, digital, and mobile platforms owned and/or controlled by third parties with whom Licensee has or enters into agreements with during the Term (“Licensee Partners”).
                    <ol style={{ listStyleType: "lower-roman" }}>
                        <li>Licensor will have an online account with Licensee known as the “Dashboard.” The Dashboard enables Licensor to see its activities with Licensee Partners.</li>
                    </ol>
                </li>
                ...
                <li>
                    The right to:
                    <ol style={{ listStyleType: "lower-roman" }}>
                        <li>perform the Content in streaming format on Licensee’s website or other websites owned and/or controlled by Licensee Partners;</li>
                        <li>publicly display and make available for download as part of the sale of the Masters, the lyrics of the Compositions;</li>
                        <li>collect monies for the playing of the Masters on non-interactive webcasts and streaming of the Masters (payable by SoundExchange in the USA). This collection right is only for Licensor’s Masters. Any monies collected on behalf of Licensor for webcasts or streams are included in “Revenue” (defined below) and are subject to the payment provisions of this Agreement;</li>
                        <li>with prior written approval from Licensor, include the Content in audio and/or audiovisual compilation(s) for sale via physical distribution, and in such cases, to manufacture, make copies of, distribute, and sell physical embodiments of the Content;</li>
                        <li>release, advertise, and sell electronic files or equivalent electronic form(s) of the Content and to permit others to do so under the trademark “BeatStars” or under any trademark used by Licensee;</li>
                        <li>sub-license the rights granted by Licensor to Licensee in this Agreement as necessary to Licensee Partners, solely to fulfill the purposes of this Agreement including but not limited to those rights necessary to promote, market, advertise, distribute and sell the Content to consumers. Licensee’s grant of rights to Licensee Partners for use of the Content shall always be subject to the terms and limitations of this Agreement.</li>
                    </ol>
                </li>

            </ol>
            <br />
            <Bold>4) Promotional & Other Rights</Bold>
            <br /><br />
            <ol style={{ listStyleType: "lower-alpha" }}>

                <li>Unless otherwise instructed in writing by Licensor, Licensee shall have the non-exclusive right, in its sole discretion and in line with customary practices, to market the Masters and other Content as applicable, for promotional purposes and without compensation to Licensor.</li>
                <li>In order for Licensee to provide marketing and licensing services under this Agreement, Licensor grants Licensee the right to:
                    <ol style={{ listStyleType: "lower-roman" }}>
                        <li>publicly perform the Masters (and other Content as applicable) on Licensee’s websites and permit Licensee Partners to publicly perform the Masters on their website(s) on a gratis basis for the purposes of promoting the sale of the Content. Licensor hereby acknowledges that Licensee and Licensee Partners shall be exempt from any payments of performance royalties otherwise due to owners of sound recordings for digital performances of the same if the use is for promotional purposes. Licensee shall require Licensee Partners to pay any public performance royalties which may be due to publishers/writers of the Compositions for promotional uses of the Compositions;</li>
                        <li>include the Masters in one or more streaming electronic radio formats to promote and market the Masters;</li>
                        <li>print, publish, disseminate, and otherwise use and permit others to use the “NIL Materials” (defined below) for the purposes of trade, advertising, and other exploitations solely in connection with the marketing, sale, and exploitation of the Content. The “NIL Materials” are defined as the approved likeness, approved biography, approved photos, and other approved promotional material provided by Licensor, including the name, both legal and professional, whether presently or hereafter used by Licensor, and name(s) of others whose work is embodied on the Content including the “Performer” (as defined below). All NIL Materials provided by Licensor to Licensee shall be deemed approved. All material provided by Licensor to Licensee may be edited to fit the format of the specific use without further approval from Licensor. Licensee shall have the right to permit Licensee Partners, successors and designees the right to use the approved NIL Materials as outlined in this subparagraph. “Performer(s)” as used in this Agreement means any person whose musical, vocal or production services are embodied on the Content.</li>
                    </ol>
                </li>
            ...
            <br /><br />
            <ol style={{ listStyleType: "lower-alpha" }}>
                <li>Licensee shall pay Licensor the percentages of “Revenue” as outlined on Revenue Shares in Appendix A of this Agreement and forming a part of it.</li>
                <li>
            ...
            <br />
            <Bold>9) Indemnification</Bold>
            <ol style={{ listStyleType: "lower-alpha" }}>
                <li>Each party (the “Indemnifying Party”) will indemnify, defend, and hold harmless the other party and its affiliates, their respective officers, directors, employees, and agents (“Indemnified Party”) from and against any and all losses, liabilities, claims, obligations, costs, and expenses (including reasonable attorney’s fees) which result from or arise in connection with or are related in any way to a breach by the Indemnifying Party of any of its representations and warranties in this Agreement. If a third party asserts a claim or allegation which, if proven, would constitute a breach by the Indemnifying Party of any of its representations, warranties, covenants and or obligations under this Agreement, the Indemnified Party shall promptly notify the Indemnifying Party in writing. The Indemnifying Party shall have the right at its own expense to participate in the defense thereof with counsel of its own choosing, provided however that the Indemnified Party’s decision in connection with the defense or settlement of any such claim or demand shall be final. No Indemnified Party shall effect any settlement of any pending or threatened proceeding with respect to which indemnity could have been sought under this Agreement by the Indemnified Party without the prior written consent of the Indemnifying Party.</li>
                <li>Licensor shall indemnify Licensee, its officers, directors, employees, and agents from and against all third party claims, actions or demands against Licensee for use of the Content as granted in this Agreement which may constitute infringement of copyright and/or trademark, and violate rights of privacy and/or publicity. Licensor explicitly indemnifies Licensee from and against any and all actions, demands, or claims brought against Licensee for non-payment or insufficient payment of mechanical royalties.</li>
            </ol>
            <br />
            <Bold>10) Termination</Bold>
            <ol style={{ listStyleType: "lower-alpha" }}>
                <li>After the Initial Term, Licensor may terminate this Agreement upon sixty (60) days written notice to Licensee and Licensee must confirm in writing receipt of such notice. Upon termination or expiration of this Agreement, the rights granted to Licensee hereunder shall automatically revert to Licensor. Additionally, Licensor may, upon sixty (60) days written notice to Licensee, terminate this Agreement with respect to any particular Master, Composition or Additional Work without effecting this Agreement for the remaining Masters, Compositions and/or Additional Works.</li>
                <li>After the Initial Term, Licensee has the right to terminate this Agreement upon sixty (60) days written notice to the Licensor. Notwithstanding the foregoing, should Licensee file for chapter 7 or chapter 11 bankruptcy proceeding, termination of this Agreement is immediate and all Content shall be returned to the Licensor.</li>
                <li>Upon termination or expiration of this Agreement for any reason, Licensee shall cease all use and distribution of the Content and shall demand that Licensee Partners cease all use and distribution of the Content. Licensee shall promptly delete all forms of the Content from its website and demand that Licensee Partners delete all forms of Content from their websites within sixty (60) days of termination of this Agreement.</li>
            </ol>

            <br />
            <Bold>11) Survival of Revenues</Bold>
            <P>Upon expiration or termination of this Agreement, all Revenues received by Licensee for the Content shall continue to be subject to the payment provisions outlined in paragraph 5 above for so long as Licensee receives such Revenues. After termination or expiration of this Agreement, the minimum payment threshold referenced in paragraph 5 shall not apply and Licensee shall pay Licensor its percentage of all Revenues received regardless of the amount payable.</P>

            <br />
            <Bold>12) Mediation & Arbitration</Bold>
            <P>If a dispute arises out of or relates to this Agreement, or if there is a breach of this Agreement, and the dispute cannot be settled or resolved, then the dispute or breach shall be settled by arbitration administered by the American Arbitration Association under its Commercial Arbitration Rules. The controversy or claim shall be settled by three (3) arbitrators, and all hearings shall be held in Austin, Texas. Judgment on the award rendered by the arbitrators may be entered in any court having jurisdiction. In rendering the award, the arbitrators shall interpret this Agreement in accordance with the substantive laws of Texas without regard to its conflict of laws rule. Notwithstanding the foregoing, if a third party claim is brought against Licensee for copyright infringement, violation of rights of publicity, rights of privacy, or other unauthorized use of Content which is contrary to the rights granted by Licensor to Licensee in this Agreement, Licensee shall not be bound by this Arbitration provision and may defend itself and make a claim against Licensor in the appropriate court of law and/or equity.</P>

            <br />
            <Bold>13) Miscellaneous</Bold>
            <br /><br />
            <ol style={{ listStyleType: "lower-alpha" }}>
                <li>Under no situation or circumstance shall Licensee be required to accept any or all Content submitted by Licensor. Licensor has none of the rights granted under this Agreement unless Licensee officially accepts Content in writing (including via e-mail). Licensee will use reasonable efforts to make the Content available for sale on third party services, carriers, websites, and/or other platforms but makes no guarantee as to the timeliness of such availability or the manner in which it is presented by Licensee Partners to the public. Licensor understands and agrees that Licensee shall not be liable for any actual or potential lost revenue due to a delay or failure to have the Content available via third party services, carriers, websites, and/or other platforms. However, Licensee will work with Licensor and Licensee Partners to facilitate as many of Licensor’s preferences as possible.</li>
                <li>If any part of this Agreement is deemed invalid or unenforceable, it shall not affect the validity or enforceability of the remainder of this Agreement, which shall remain in full force and effect as if such invalid or unenforceable provision(s) were not a part hereof.</li>
                <li>This Agreement shall be binding upon and shall inure to the benefit of the parties and their respective heirs, executors, successors in interest, and assigns.</li>
                <li>In entering into and performing this Agreement, Licensor and Licensee each have the status of independent contractors. This Agreement shall not be deemed to create a partnership or joint venture between the parties and neither is the other’s partner or employee.</li>
                <li>This Agreement and the document at <a href='https://beatstars.zendesk.com/hc/en-us'>https://beatstars.zendesk.com/hc/en-us</a> contain the entire understanding between the parties with respect to the subject matter hereof and may only be modified, altered, or amended by a written agreement signed by all parties. For purposes of this provision, a written modification, alteration, or amendment shall include e-mail transmission with proof of receipt and acceptance by the receiving party.</li>
                <li>Licensor agrees that it enters into this Agreement with all knowledge of its terms, freely and voluntarily, and with a complete understanding of all the consequences of entering into this Agreement. Licensor acknowledges that it has been represented in the negotiation and execution of this Agreement by an independent attorney of Licensor’s choice who is familiar with the practices of the entertainment industry or Licensor has willingly refrained from so doing.</li>
                <li>Subject to and in accordance with paragraph 12 above, this Agreement shall be governed by and construed in accordance with the laws of the State of without giving effect to any choice of law principles.</li>
                <li>All notices and communication desired or required between the parties may be made via e-mail transmission, provided however that the sending party obtain proof of receipt of such communication by the recipient either by return e-mail, follow up telephone call, or facsimile. Notices that pertain to any claim referenced in paragraph 9 shall be given in writing and delivered in any of the following ways: personally, via a commercial carrier which provides proof of delivery whether or not such delivery is made overnight with the postage prepaid.</li>
            </ol>
            <br></br>
            <P>The Parties have entered into this Agreement on the date first written above.</P>
            <br></br><br></br>
